...
var Account, EventEmitter, ImapPool, Mailbox, Message, Scheduler, accountsByID, allAccounts, async, countsByMailboxID, eventEmitter, imapPools, log, mailboxesByAccountID, mailboxesByID, onMessageCreated, onMessageDestroyed, orphanMailboxes, retrieveAccounts, retrieveCounts, retrieveMailboxes, retrieveTotalCounts, unreadByAccountID, _,
...
exports.getAccountClientObject = function(id) {
  var rawObject, _ref;
  rawObject = (_ref = accountsByID[id]) != null ? _ref.toObject() : void 0;
  if (!rawObject) {
    return null;
  }
